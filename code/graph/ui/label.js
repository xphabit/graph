...
(function (ui) {
    var Text = /** @class */ (function (_super) {
        ...
        function Text(parent, option) {
            var _this = this;
            option = option || {};
            option.uiLabelOption_tag = option.uiLabelOption_tag || "span";
        ...
        Text.prototype.uiControl_create = function (html) {
            ...
            self.uiControl_control = html.sysHtml_element(option.uiLabelOption_tag, option.uiControlOption_class);
