...
Sidebar.prototype.init = function()
{
	...
	var _this = this._;
	_this.addSearchPalette(true);
	_this.addGeneralPalette(true);
	_this.addMiscPalette(false);
	_this.addAdvancedPalette(false);
	_this.addBasicPalette(dir);
	_this.addStencilPalette('arrows', mxResources.get('arrows'), dir + '/arrows.xml',
		';whiteSpace=wrap;html=1;fillColor=#ffffff;strokeColor=#000000;strokeWidth=2');
	_this.addUmlPalette(false);
	_this.addBpmnPalette(dir, false);
	_this.addStencilPalette('flowchart', 'Flowchart', dir + '/flowchart.xml',
		';whiteSpace=wrap;html=1;fillColor=#ffffff;strokeColor=#000000;strokeWidth=2');
	_this.addImagePalette('clipart', mxResources.get('clipart'), dir + '/clipart/', '_128x128.png',
...
Sidebar.prototype.addSearchPalette = function(expand)
{
	...
	cross.className = "_xi_search";
	cross.style.top = '22px';
...
Sidebar.prototype.createTitle = function(label)
{
	...
	span.className = "_xi_rcaret";
	span.style.cssText = "width:4px;height:4px;left:5px;top:50%;transform-origin:top";
...
Sidebar.prototype.addFoldingHandler = function(title, content, funct)
{
	...
	*/
	title.children[0].className = (content.style.display == 'none') ? '_xi_rcaret' : '_xi_dcaret';
	mxEvent.addListener(title, 'click', mxUtils.bind(this, function(evt)
	{
		if (content.style.display == 'none')
		{
			...
			title.children[0].className = '_xi_dcaret';
			//title.style.backgroundImage = 'url(\'' + this.expandedImage + '\')';
		}
		else
		{
			//title.style.backgroundImage = 'url(\'' + this.collapsedImage + '\')';
			title.children[0].className = '_xi_rcaret';
