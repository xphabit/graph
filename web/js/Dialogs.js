...
var EditDataDialog = function(ui, cell)
{
	...
	var addRemoveButton = function(text, name)
	{
		...
		var removeAttr = $1.h/*sysHtml_element*/('a', '_xi_close geButton');
		$1.g/*sysHtml_css*/(removeAttr, "right:0px;top:2px;width:12px;height:12px;");
		$1.f/*sysHtml_attribute*/(removeAttr, 'title', mxResources.get('delete'));
