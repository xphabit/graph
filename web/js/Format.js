...
Format.prototype.init = function()
{
	...
	var diagram=sys.Pod.x(box.Diagram);
	diagram.e(); //boxDiagram_start
 ...
 * Switch among 
 */
Format.prototype.switchPanel = function(idx)
{
	if (this.currentIndex != idx) {
		if(this.currentIndex != -1) {
			this.panels[this.currentIndex].container.style.display = 'none';
			this.labels[this.currentIndex].style.display = 'none';
		}
		this.currentIndex = idx;
		this.panels[idx].container.style.display = '';
		this.labels[idx].style.display = '';
	}
}
...
Format.prototype.refresh = function()
{
	var $1 = sys.Html;
	var ui = this.editorUi;
	var edgebar = sys.Pod.x(box.Edgebar);
	if(ui.formatWidth <= 34) {
		return;
	}
...
DiagramFormatPanel.prototype.init = function()
{
	...
	this.container.appendChild(diagram.j().v);
	//this.container.appendChild(this.addView(this.createPanel()));

	if (graph.isEnabled())
	{
		this.container.appendChild(diagram.c().v);
